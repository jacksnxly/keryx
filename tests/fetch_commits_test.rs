...
fn test_fetch_commits_empty_range_same_commit() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit1)
...
fn test_fetch_commits_single_commit_range() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit2)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_multiple_commits_range() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit4)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_preserves_order() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit5)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_with_merge_commit() {
    ...
    let commits = fetch_commits(&test_repo.repo, base, merge)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_parses_conventional_commits() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit3)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_long_commit_history() {
    ...
    let commits = fetch_commits(&test_repo.repo, first, last)
        .expect("Failed to fetch commits");
