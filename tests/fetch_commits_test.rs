...
fn test_fetch_commits_empty_range_same_commit() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit1, false)
...
fn test_fetch_commits_single_commit_range() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit2, false)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_multiple_commits_range() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit4, false)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_preserves_order() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit5, false)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_with_merge_commit() {
    ...
    let feature_commit = {
        ...
        test_repo
            .repo
            .commit(None, &sig, &sig, "feat: feature commit", &tree, &[&base_commit])
            .unwrap()
    };
    ...
    let commits = fetch_commits(&test_repo.repo, base, merge, false)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_parses_conventional_commits() {
    ...
    let commits = fetch_commits(&test_repo.repo, commit1, commit3, false)
        .expect("Failed to fetch commits");
...
fn test_fetch_commits_long_commit_history() {
    ...
    let commits = fetch_commits(&test_repo.repo, first, last, false)
        .expect("Failed to fetch commits");
