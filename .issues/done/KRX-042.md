...
## Problem
The `find_root_commit` function collects traversal errors but doesn't fail—it just warns and returns potentially incomplete results. The returned root commit may not be the actual root.
